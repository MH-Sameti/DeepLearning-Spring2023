...
def slice_assignment_practice(x):
  ...
  x[2:4, 2:6] = torch.tensor([[3, 4, 5, 5], [3, 4, 5, 5]])
  #############################################################################
  #                            END OF YOUR CODE                               #
  #############################################################################
  return x
...
def reshape_practice(x):
  ...
  y[1], y[3] = y[3].clone(),  y[1].clone()
  y[2], y[3] = y[3].clone(),  y[2].clone()
  y[3], y[4] = y[4].clone(),  y[3].clone()
